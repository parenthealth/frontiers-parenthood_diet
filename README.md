...
2. Open the file 00cr-cpf-master.do in 1_scripts\cpf to construct the CPF file for harmonized covariates over the two countries. Within the file note that you need to insert the raw data sets (see next step).
