/*==============================================================================
File:         	03cr-cpf-andata$ps.doa.do
...
clear
local data= "$surveys"	// hilda ukhls
...
isvar  	///		
	...
	kidsn_hh17 kidsn_hh15 kidsn_all kids_any ch1by4 nkids_dv ///
	panl-ndrinkhmd
...
order country orgpid pid wave wavey intyear intmonth respstat ///
		...
		ch1by4 kidsn_hh17 kidsn_hh15 kidsn_all kids_any nphh nkids_dv ///
		sampid*	
...
rename ch1by4 ch1by4_uk
rename nkids_dv nchhh_uk
...
lab var ch1by4_uk "Birth year first child (UK)"
...
log using "${logs}/03cpf_inspect$ps.log", replace
...
label data "CPF (diet, parenthood)"
	datasignature set, reset

save "${Gcpf_out}\CPF-di.dta", replace
